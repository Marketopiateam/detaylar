                            ...
                            @foreach (getLanguages() as $key => $language)
                                <li class="nav-item">
                                    <a class="nav-link  @if ($key == 0) text-primary font-weight-bold text-lg active @endif"
                                        id="language-tab{{ $language->language_id }}" data-toggle="tab"
                        ...
                        <div class="tab-content tab-validate" style="margin-top:20px;">
                            @foreach (getLanguages() as $key => $language)
                                @php
                                    $find = array_search(
                                        $language->id,
                                        array_column($data->categoryMultipleDescription->toArray(), 'language_id'),
                                    );
                                @endphp
                                        ...
                                        @if ($language->id == $langdata->language_id)
                                            <div class="pl-lg-4 row">
                                                ...
                                                <div
                                                    ...
                                                    <input type="text"
                                                        name="multilanguage[{{ $langdata->language_id }}][meta_title]"
                                                        id="meta_title"
                                                        class="form-control form-control-alternative{{ $errors->has('meta_title') ? ' is-invalid' : '' }}"
                                                        placeholder="{{ __('Meta Title') }}"
                                                        value="{{ old('meta_title', $langdata->meta_title) }}" autofocus>
                                                ...
                                                <div
                                                    ...
                                                    <textarea name="multilanguage[{{ $langdata->language_id }}][meta_description]" id="meta_description"
                                                        ...
                                                        placeholder="{{ __('Meta Description') }}" rows="3">{{ old('meta_description', $langdata->meta_description) }} </textarea>
                                        ...
                                        <div class="pl-lg-4 row">
                                            ...
                                            <div
                                                ...
                                                <label class="form-control-label"
                                                    for="input-name">{{ __('Meta Title') }}</label>
                                                <input type="text"
                                                    name="multilanguage[{{ $language->id }}][meta_title]" id="meta_title"
                                                    class="form-control form-control-alternative{{ $errors->has('meta_title') ? ' is-invalid' : '' }}"
                                                    placeholder="{{ __('Meta Title') }}"
                                                    value="{{ old('meta_title', '') }}" autofocus>
                                            ...
                                            <div
                                                ...
                                                <label class="form-control-label"
                                                    for="input-name">{{ __('Meta Keyword') }}</label>
                                                <input type="text"
                                                    name="multilanguage[{{ $language->id }}][meta_keyword]"
                                                    id="meta_keyword"
                                                    class="form-control form-control-alternative{{ $errors->has('meta_keyword') ? ' is-invalid' : '' }}"
                                                    placeholder="{{ __('Meta Keyword') }}"
                            ...
                            <div class="col-md-6 form-group{{ $errors->has('parent_id') ? ' has-danger' : '' }}">
                                ...
                                <select class="form-control" name="parent_id">
                                    ...
                                    @foreach ($parentCategory as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ $key == $data->parent_id ? 'selected' : '' }}>{{ $value }}</option>
                                    @endforeach
                                </select>
